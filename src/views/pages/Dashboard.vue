            ...
            <v-row dense justify="center" align="center" align-content="center">
                <v-col cols="12" md="12" sm="12" class="pb-0">
                    <v-hover v-slot="{ hover }">
                        <base-material-card :kinesisActive="false" :color="hover ? 'green lighten-1' :'green'" max-width="100%" width="auto" :style="hover ? 'filter: drop-shadow(3px 3px 7px green) invert(5%);' : 'filter: opacity(100%);'" class="px-5 py-3 mx-auto">
