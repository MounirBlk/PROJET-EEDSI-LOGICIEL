                ...
                <template v-slot:heading>
                    ...
                    <div v-else>
                        <div class="display-2 white--text mb-4">
                            <v-icon large>mdi-pencil</v-icon>Modification produit
                        </div>
                    </div>
                </template>
        ...
        <v-col cols="12" md="4">
            ...
            <div v-else>
                <base-material-card color="brown" icon="mdi-cog" max-width="100%" width="auto" inline class="px-5 py-3 mx-auto">
                    ...
                    <v-row>
                        <v-col cols="12">
                            <h4 class="subtitle-1 font-weight-light mb-2 text-md-center">Liste de composants</h4>
                        </v-col>
                        <v-card-text>
                            <v-col cols="12">
                                <v-simple-table dense>
                                    <template v-slot:default>
                                        <tbody>
                                            <tr>
                                                <td>Pied de meuble en or</td>
                                            </tr>
                                            <tr>
                                                <td>Mousse en or au niveau du dos</td>
                                            </tr>
                                            <tr>
                                                <td>Mousse en argent au niveau du dos</td>
                                            </tr>
                                            <tr>
                                                <td>Mousse au niveau du bas</td>
                                            </tr>
                                            <tr>
                                                <td>Mousse au niveau du coté</td>
                                            </tr>
                                            <tr>
                                                <td>Mousse au niveau du des contours</td>
                                            </tr>
                                        </tbody>
                                    </template>
                                </v-simple-table>
...
export default Vue.extend({
    ...
    mounted(): any {
        if (
            this.$route.params.infosProduit != null &&
            this.$route.params.infosProduit != 0
        ) {
            setTimeout(() => {
